...
The user sent the following message which you have not yet responded to:
<pending_request>
{pending_request}
</pending_request>

Please respond to the pending request above, using the context summary as background.\
"""
