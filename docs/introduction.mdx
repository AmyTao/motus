...
Agentic inference is exploding. Motus enables **higher capability, lower cost, and faster agents**, and keeps deployment simple across local and cloud environments at any scale.

You bring the agent. Motus runs it, serves it, and deploys it. The agent can come from any framework you already use, or from Motus's own agent toolkit, which gives you a complete, batteries included stack for writing production ready agents in clean Python.
...
`lithosai-motus` is the Python package. It ships with a complete, batteries included stack for writing, running, and operating agents in clean Python. Here is what you get.
...
<CardGroup cols={2}>
  ...
  <Card title="Workflows" icon="diagram-project" href="/concepts/runtime">
