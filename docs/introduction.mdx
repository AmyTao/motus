...
See [OpenAI Agents integration](/integrations/openai-agents),
[Anthropic SDK integration](/integrations/anthropic-sdk), and
[Google ADK integration](/integrations/google-adk) for details.
