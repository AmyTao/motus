...
<Tip>
  Annotate your parameters. Unannotated ones are dropped from the schema: if they have a default, it's always used; if they don't, the tool crashes when called.
</Tip>
